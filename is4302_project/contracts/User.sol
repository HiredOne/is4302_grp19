...
contract User {
    ...
    function checkIsAdmin(address userID) public view returns (bool) {
        if(usersCreated[userID].admin == adminState.isAdmin) {
            return true;
        } else {
            return false;
        }
    ...
    function getTotalNumberOfUsers() public view returns (uint256) {
