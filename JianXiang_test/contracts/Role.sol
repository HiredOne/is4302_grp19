...
contract Role {
    ...
    // function removeUserRole(address userID, uint256 roleID) adminOnly(msg.sender) validRole(role) public {
    //     require(rolesGrantedToUser[userID][roleID] == 1, "User does not have this role yet");

    //     rolesGrantedToUser[userID][roleID] = 0; // Update rolesGrantedToUser
